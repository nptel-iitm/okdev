...
- Manual test cases from `{project}/.agentforge/test-plan.md` (Section 7)
...
### 4. Report
Output to `{project}/.agentforge/test-results/manual-spot-check.md`:
```markdown
...
Save screenshots to `{project}/.agentforge/test-results/screenshots/manual/`
